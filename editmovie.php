        ...
        <div class="col-md-6 offset-md-1">
          ...
          <form id="edit-movie-form" action="<?= $BASE_URL ?>movie_process.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" name="title" id="title" placeholder="Digite o nome do filme" value="<?= $movie->title ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" name="length" id="length" placeholder="Qual a duração do filme?" value="<?= $movie->length ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" name="trailer" id="trailer" placeholder="Insira o link do trailer" value="<?= $movie->trailer ?>">
            </div>
            <div class="form-group">
            ...
            <input type="submit" class="botao" value="Editar Filme">
          </form>
        </div>
        <div class="col-md-3">
